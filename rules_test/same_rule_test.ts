...
Deno.test("rules:same", function (): void {
  ...
  assertEquals(ruleHandler("123456", new ValidatorLite({ confirmPassword: "123456" })), true);
  assertEquals(ruleHandler("123456", new ValidatorLite({ confirmPassword: "123123" })), false);
});
